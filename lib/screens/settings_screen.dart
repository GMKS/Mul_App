...
import 'admin/translation_admin_screen.dart';
                ...
                return ListView(
                  ...
                  children: [
                    ...
                    if (_isAdmin) ...[
                      ...
                      // Local Deals Approval (Admin only)
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                              ...
                              const Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: 4),
                                    Text(
                                      'Translate businesses to Telugu & Hindi',
                                      style: TextStyle(
                                        color: Colors.white70,
                                        fontSize: 12,
                                      ),
